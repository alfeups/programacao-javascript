...
Só que a numeração que encontraram estava invertida e como muitas delas foram descobertas, os
 cientistas chamaram você para conseguir automatizar esse processo. Logo, dado um número grande,
...
let stringNum = []; // string contendo um número de entrada
let arrayNum = []; // array contendo o número
let numero; // inteiro representando o número de entrada

// Entrada dos dados
stringNum = gets();
numero = parseInt(stringNum);
